enum Enchants
{
    ...
    ENCHANT_WEP_MIGHTY_SPELL_POWER      = 3834, // Una mano
    ...
    ENCHANT_CLOAK_GREATER_SPEED         = 3831,
		...
		ENCHANT_WAIST_ETERNALBELTBUCKLE				    = 3729,
		ENCHANT_WAIST_FRAGBELT							= 3601,
		ENCHANT_WAIST_PEMGENERATOR						= 3599,
};
...
void Enchant(Player* player, Item* item, uint32 enchantid)
{
    if (!item)
    {
        player->GetSession()->SendNotification("Primero deberias equiparte el objeto al que intentas encantar.");
        return;
    }
    ...
    player->GetSession()->SendNotification("|cff800080%s |cffFF0000Encantado correctamente!", item->GetTemplate()->Name1.c_str());
}
...
void RemoveEnchant(Player* player, Item* item)
{
        if (!item)
        {
                player->GetSession()->SendNotification("Tienes ese objeto equipado?");
                return;
        }
 
        item->ClearEnchantment(PERM_ENCHANTMENT_SLOT);
        player->GetSession()->SendNotification("|cff800080%s |cffFF0000Encantamiento removido correctamente", item->GetTemplate()->Name1.c_str());
}
            ...
            switch (action)
            {
                ...
                case 2: // Enchant 2H WeAPon
                                        {
                                                ...
                                                if (!item)
                                                {
                                                        player->GetSession()->SendNotification("Debes equiparte un Arma de Dos Manos primero.");
                                                ...
                                                {
                                                        player->GetSession()->SendNotification("No tienes un Arma de Dos Manos equipada.");
                                                        player->PlayerTalkClass->SendCloseGossip();
                                                }
                                        }
                                        break;
                ...
                case 3: // Enchant Shield
                                        {
                                                ...
                                                if (!item)
                                                {
                                                        player->GetSession()->SendNotification("Debes equiparte un escudo primero.");
                                                        player->PlayerTalkClass->SendCloseGossip();
                                                        return false;
                                                }
                                                ...
                                                {
                                                        player->GetSession()->SendNotification("No tienes un escudo equipado.");
                                                        player->PlayerTalkClass->SendCloseGossip();
                                                }
                                        }
                                        break;
                                ...
                                case 13: //Enchant Off-Hand weAPons
                                        {
                                                ...
                                                if(!item)
                                                {
                                                        player->GetSession()->SendNotification("Necesitas un arma equipada en la Mano Secundaria.");
                                                        player->PlayerTalkClass->SendCloseGossip();
                                                        return false;
                                                }
                                                ...
                                                {
                                                        player->GetSession()->SendNotification("No tienes un arma equipada en la Mano Secundaria.");
                                                        player->PlayerTalkClass->SendCloseGossip();
                                                }
                                        }
                                        break;
                ...
                case 104:
                                ...
                                case 115:
                                        {
                                                ...
                                                if (!item)
                                                {
                                                        player->GetSession()->SendAreaTriggerMessage("Este encantamiento necesita un Arma de Dos Manos equipada.");
                                                        player->PlayerTalkClass->SendCloseGossip();
                                                        return false;
                                                }
                                                ...
                                                {
                                                        player->GetSession()->SendAreaTriggerMessage("No tienes un Arma de Dos Manos equipada.");
                                                        player->PlayerTalkClass->SendCloseGossip();
                                                }
                                        }
                    break;
                                ...
                                case 118:
                                        {
                                                ...
                                                if(!item)
                                                {
                                                        player->GetSession()->SendAreaTriggerMessage("Este encantamiento necesita tener equipado un Escudo");
                                                        player->PlayerTalkClass->SendCloseGossip();
                                                        return false;
                                                }
                                                ...
                                                {
                                                        player->GetSession()->SendAreaTriggerMessage("No tienes un Escudo equipado.");
                                                        player->PlayerTalkClass->SendCloseGossip();
                                                }                                              
                                        }
                    break;
                    ...
                    break;
					            ...
					            case 420:
                                        Enchant(player, player->GetItemByPos(INVENTORY_SLOT_BAG_0, EQUIPMENT_SLOT_WAIST), ENCHANT_WAIST_ETERNALBELTBUCKLE);
                    player->PlayerTalkClass->SendCloseGossip();	
                    break;
					
					            case 421:
                                        Enchant(player, player->GetItemByPos(INVENTORY_SLOT_BAG_0, EQUIPMENT_SLOT_WAIST), ENCHANT_WAIST_FRAGBELT);
                    player->PlayerTalkClass->SendCloseGossip();	
                    break;
					
					            case 422:
                                        Enchant(player, player->GetItemByPos(INVENTORY_SLOT_BAG_0, EQUIPMENT_SLOT_WAIST), ENCHANT_WAIST_PEMGENERATOR);
                    player->PlayerTalkClass->SendCloseGossip();	
                    break;
                                ...
                                case 205:
                                        {
                                                ...
                                                if(!item)
                                                {
                                                        player->GetSession()->SendAreaTriggerMessage("No tienes un arma equipada en la Mano Secundaria.");
                                                        player->PlayerTalkClass->SendCloseGossip();
                                                        return false;
                                                }
                                ...
                                case 410: //remove enchant for rings
                                ...
                                case 411: //remove enchant for waist
