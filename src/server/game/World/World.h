...
public:
    ...
    void SendAreaMessage(uint32 area, WorldPacket* packet, ...) override;
    void SendAreaText(uint32 area, const char* text, ...) override;
    void SendAllWorldMessage(WorldPacket* packet, ...) override;
    void SendAllWorldText(const char* text, ...) override;
    void SendPlayerMessage(WorldPacket* packet, ...) override;
    void SendPlayerText(Player* player, const char* text, ...) override;
