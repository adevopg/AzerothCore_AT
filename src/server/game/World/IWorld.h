...
enum WorldBoolConfigs
{
    ...
    CONFIG_DUEL_RESET_COOLDOWN_ONLY_IN_ZONA_DE_DUELOS,
...
public:
    ...
    virtual void SendAreaMessage(uint32 area, WorldPacket* packet, ...) = 0;
    virtual void SendAreaText(uint32 area, const char* text, ...) = 0;
    virtual void SendAllWorldMessage(WorldPacket* packet, ...) = 0;
    virtual void SendAllWorldText(const char* text, ...) = 0;
    virtual void SendPlayerMessage(WorldPacket* packet, ...) = 0;
    virtual void SendPlayerText(Player* player, const char* text, ...) = 0;
